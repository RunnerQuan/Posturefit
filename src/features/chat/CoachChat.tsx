...
import { ArrowDown, CheckCircle2, ExternalLink, Flame, RefreshCw, SendHorizontal, Timer } from 'lucide-react';
    ...
    >
      ...
      {showScrollToBottom && (
        <button
          ...
          className="absolute bottom-28 right-6 z-30 inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/92 px-4 py-2 text-sm font-medium text-blush-700 shadow-soft backdrop-blur-xl transition hover:bg-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blush-300"
